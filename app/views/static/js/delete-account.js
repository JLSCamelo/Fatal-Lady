...
async function handleDelete(overlay) {
    ...
    try {
        ...
        if (resposta.ok) {
            closeModal();
            showToast("success", "Enviamos um e-mail com instruções para concluir a exclusão da conta.");
            return;
        }
...
function showToast(type, text) {
    ...
    toast.innerHTML = `
        ...
        <div class="status-toast__content">
            <strong class="status-toast__title">${type === "success" ? "Tudo certo!" : "Erro"}</strong>
